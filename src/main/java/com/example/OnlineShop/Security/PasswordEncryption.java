...
public class PasswordEncryption {
    ...
    public PasswordEncryption() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
...
// login check if password is same with the one from user
//add message if pass doesn't match and if pass match
